...
class Opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='gaila_ctdet',
        ...
        # model
        self.parser.add_argument('--arch', default='simple',
                                 help='model architecture. Currently tested'
                                      'simple | res_18 | res_101 | resdcn_18 | resdcn_101 |'
                                      'dlav0_34 | dla_34 | hourglass | simple')
